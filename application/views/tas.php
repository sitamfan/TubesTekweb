...
<body>
    <h1>Daftar Tas</h1>
    <p><a href="<?php echo site_url('home/tambahtas'); ?>" class="btn btn-warning btn-sm">Tambah</a></p>
    <?php
    $template = array(
    ...
    foreach ($results as $r) {
        $edit = '<a href="' . site_url("home/updatetas/" . $r->id) . '">edit</a>';
        $hapus = '<a href="' . site_url("home/hapustas/" . $r->id) . '">hapus</a>';
